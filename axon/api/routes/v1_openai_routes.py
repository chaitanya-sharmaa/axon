...
from axon.core.app_config import axon_service, memory_store
from axon.core.settings import settings
from axon.services.agentic.pipeline import optimize_request as agentic_optimize
from axon.services.agentic.pipeline import update_after_response as agentic_post
from axon.services.fact_extractor import extract_facts_async
from axon.services.kv_cache import kv_cache
from axon.services.pii_redactor import pii_redactor
from axon.services.pricing import estimate_cost_usd, estimate_savings_usd
from axon.services.prompt_firewall import prompt_firewall
from axon.services.request_logger import request_logger
from axon.services.schema_validator import schema_validator
from axon.services.semantic_cache import semantic_cache
from axon.services.smart_router import fallback_model, get_load_balanced_key, route_model
from axon.services.text_pruner import prune_text
from axon.services.tool_compressor import compress_tools_to_prompt, reconstruct_tool_calls
        ...
        for idx, msg in enumerate(messages):
            ...
            # 2. Text Pruning & Compression
                ...
                if settings.enable_llmlingua_compression and len(content) > 1000:
                    from axon.services.llmlingua_compressor import llmlingua_compressor
            ...
            if tokenizer is not None:
                ...
                if delta_text:
                    ...
                    if max_spend is not None:
                        ...
                        from axon.services.pricing import estimate_cost_usd
