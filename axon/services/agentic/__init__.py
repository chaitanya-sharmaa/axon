...
Usage:
    from axon.services.agentic import pipeline
...
from axon.services.agentic import pipeline
from axon.services.agentic.pipeline import (
    AgenticOptimizationResult,
    optimize_request,
    update_after_response,
)
from axon.services.agentic.session_state import agentic_state_manager
