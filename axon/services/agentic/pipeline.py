...
from axon.services.agentic import (
    error_truncator,
    loop_detector,
    observation_window,
...
from axon.services.agentic.session_state import AgenticSessionState, agentic_state_manager
...
def optimize_request(
    ...
    try:
        if getattr(__import__('axon.core.settings', fromlist=['settings']).settings,
    ...
    if state is not None:
        ...
        try:
            if tools and getattr(
                __import__('axon.core.settings', fromlist=['settings']).settings,
